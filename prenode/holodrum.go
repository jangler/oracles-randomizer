...
var holodrumPrenodes = map[string]*Prenode{
	...
	"dimitri": Or("dimitri's flute",
		And(Or("natzu prairie", "natzu wasteland"), "sunken gale tree", "bombs")),
	...
	"moosh": And("mount cucco", Or("moosh's flute",
		And(Or("natzu prairie", "natzu river"), "spring banana"))),
