...
var AgesSlots = map[string]*MutableSlot{
	...
	"d7 diamond/cane puzzle":   agesChest("d7 small key", 0x5297, 0x05, 0x53),
	...
	"d8 NW slate chest":        agesChest("slate 1", 0x52c3, 0x05, 0x7c),
	"d8 NE slate chest":        agesChest("slate 2", 0x52c7, 0x05, 0x7e),
	"d8 ghini chest":           agesChest("dungeon map", 0x52cb, 0x05, 0x85),
	"d8 SE slate chest":        agesChest("slate 3", 0x52cf, 0x05, 0x92),
	"d8 SW slate chest":        agesChest("slate 4", 0x52d3, 0x05, 0x94),
