...
func initAgesSlots() map[string]*MutableSlot {
	return map[string]*MutableSlot{
		// overworld present
		"starting chest": basicSlot("sword", 0x00, 0x10f8, 0x10f7,
		...
		"balloon guy's upgrade": agesScriptItem("satchel", 0x7e7a, 0x00, 0x79),
		...
		"tokkey's composition":     agesBufferItem("harp", 0x76cf, 0x03, 0x8f),
		...
		"d6 present vire chest":    agesChest("flippers", 0x524f, 0x05, 0x13),
		...
		"d7 miniboss chest":        agesChest("switch hook", 0x5293, 0x05, 0x4e),
