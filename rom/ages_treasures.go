...
var AgesTreasures = map[string]*Treasure{
	...
	"sword":           agesTreasure(0x05, 0x00, 0x54e6, 0x09, 0x01, 0x1c, 0x10),
	"boomerang":       agesTreasure(0x06, 0x00, 0x5502, 0x0a, 0x01, 0x22, 0x1c),
	"switch hook":     agesTreasure(0x0a, 0x00, 0x550e, 0x38, 0x01, 0x30, 0x1f),
	...
	"bracelet":        agesTreasure(0x16, 0x00, 0x554a, 0x0a, 0x01, 0x26, 0x19),
	"feather":         agesTreasure(0x17, 0x00, 0x555a, 0x0a, 0x01, 0x27, 0x16),
	"satchel":         agesTreasure(0x19, 0x02, 0x556e, 0x29, 0x00, 0x2d, 0x20),

	// collection items
	// "harp" as defined here is actually the tune of echoes item, which gives
	// the actual harp item along with itself.
	"harp":            agesTreasure(0x25, 0x00, 0x53c6, 0x68, 0x00, 0x72, 0x69),
	...
	"slate":           agesTreasure(0x4b, 0x00, 0x545e, 0x38, 0x00, 0x48, 0x50),
