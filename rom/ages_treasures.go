...
var AgesTreasures = map[string]*Treasure{
	...
	"bracelet 2":      agesTreasure(0x16, 0x01, 0x554e, 0x38, 0x01, 0x26, 0x19),
	...
	// not used; trade items work specially and share the same ID
	// "broken sword": agesTreasure(0x41, 0x0b, 0x573a, 0x0a, 0x0b, 0x65, 0x7b),

	// collection items
	"harp 1":          agesTreasure(0x25, 0x00, 0x53c6, 0x68, 0x00, 0x72, 0x68),
	"harp 2":          agesTreasure(0x25, 0x00, 0x53c6, 0x68, 0x00, 0x72, 0x68),
	"harp 3":          agesTreasure(0x25, 0x00, 0x53c6, 0x68, 0x00, 0x72, 0x68),
	"flippers 1":      agesTreasure(0x2e, 0x00, 0x56ce, 0x0a, 0x00, 0x31, 0x31),
	"flippers 2":      agesTreasure(0x2e, 0x01, 0x56d2, 0x38, 0x00, 0x31, 0x31),
	...
	// slates are broken into individual items for logical convenience
	"slate 1": agesTreasure(0x4b, 0x00, 0x545e, 0x38, 0x00, 0x48, 0x50),
	"slate 2": agesTreasure(0x4b, 0x00, 0x545e, 0x38, 0x00, 0x48, 0x50),
	"slate 3": agesTreasure(0x4b, 0x00, 0x545e, 0x38, 0x00, 0x48, 0x50),
	"slate 4": agesTreasure(0x4b, 0x00, 0x545e, 0x38, 0x00, 0x48, 0x50),
	...
	"heart container": agesTreasure(0x2a, 0x00, 0x560a, 0x1a, 0x04, 0x16, 0x3b),
	...
	"d1 small key":         agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d2 small key":         agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d3 small key":         agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d4 small key":         agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d5 small key":         agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d6 present small key": agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d6 past small key":    agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d7 small key":         agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
	"d8 small key":         agesTreasure(0x30, 0x03, 0x56e2, 0x38, 0x01, 0x1a, 0x42),
