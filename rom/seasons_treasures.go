...
var seasonsTreasures = map[string]*Treasure{
	// equip items
	"shop shield L-1": seasonsTreasure(0x01, 0x00, 0x52bd, 0x0a, 0x01, 0x1f, 0x13),
	...
	"rang ring L-1":  seasonsTreasure(0x2d, 0x07, 0x53d5, 0x38, 0x0c, 0x54, 0x0e),
	"blast ring":     seasonsTreasure(0x2d, 0x08, 0x53d9, 0x38, 0x0d, 0x54, 0x0e),
