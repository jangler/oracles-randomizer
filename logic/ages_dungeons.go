...
var agesD2Nodes = map[string]*Node{
	...
	"d2 statue room": And("d2 moblin platform", "bracelet"),
...
var agesD4Nodes = map[string]*Node{
	"d4 first chest": AndSlot("enter d4", Or("kill stalfos", "pit normal"),
		Or("feather", "switch hook")),
	"d4 key chest A":    And("d4 first chest", "feather"),
	"d4 minecart A":     And("enter d4", "feather", "d4 key A"),
	"d4 key chest B":    And("d4 minecart A", "any seed shooter"),
	...
	"d4 small floor puzzle": AndSlot("d4 minecart D", "bombs",
		Or("sword", "bomb weapon", "scent seeds", "switch hook")),
	...
	"d4 key D": And("d4 minecart C", "any seed shooter",
		Or("ember seeds", "scent seeds", "gale seeds", "mystery seeds")),
...
var agesD5Nodes = map[string]*Node{
	...
	"d5 boxed chest":    And("d5 switch A", "switch hook"),
...
var agesD6Nodes = map[string]*Node{
	...
	"d6 present hand room": And("enter d6 present", Or("flippers", "feather"),
		Or("any seed shooter", "boomerang")),
